...
import { Calculator, Users, CheckCircle, Target, BarChart3, TrendingUp, ArrowRight, BookOpen, Lightbulb, Zap, ArrowLeft } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <p className="text-slate-600 text-lg max-w-3xl mx-auto">
              Panduan lengkap memahami Analytic Hierarchy Process (AHP) untuk pengambilan keputusan yang akurat dan terstruktur
            </p>
          </motion.div>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-r from-blue-50 to-cyan-50">
              <CardContent className="text-center p-8">
                <h2 className="text-2xl font-bold text-slate-800 mb-4">
                  Siap Mencoba AHP Tools?
                </h2>
                <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
                  Mulai buat project AHP Anda atau coba demo untuk merasakan pengalaman menggunakan metode AHP
                </p>
